					...
					u8 *txbuf, int size)
{
	...
	*/
	...
	iowrite16(0xF234, fpga_pointer + 0x2000);
	iowrite16(0xF234, fpga_pointer + 0x2002);
	iowrite16(0xF234, fpga_pointer + 0x2004);
	iowrite16(0xF234, fpga_pointer + 0x2006);
	iowrite16(0xF234, fpga_pointer + 0x2008);
...
static int __devinit gpmcfb_probe(struct platform_device *dev)
{
   ...
   ret_val =  gpmc_cs_set_timings(cs, &fpga_timings);
	...
	iowrite16(0xF034, fpga_pointer + 0x4000);
	iowrite16(0xF134, fpga_pointer + 0x4002);
	iowrite16(0xF234, fpga_pointer + 0x4004);
	iowrite16(0xF334, fpga_pointer + 0x4006);
	iowrite16(0xF434, fpga_pointer + 0x4008);
	iowrite16(0xF534, fpga_pointer + 0x400a);
	iowrite16(0xF634, fpga_pointer + 0x400c);
