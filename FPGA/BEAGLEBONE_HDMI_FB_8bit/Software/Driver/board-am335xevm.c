...
//hong
static struct pinmux_config fpga_gpmc_pin_mux[] = {
	{"gpmc_ad0.gpmc_ad0",	  OMAP_MUX_MODE0 | AM33XX_PIN_INPUT_PULLUP},
	{"gpmc_ad1.gpmc_ad1",	  OMAP_MUX_MODE0 | AM33XX_PIN_INPUT_PULLUP},
	{"gpmc_ad2.gpmc_ad2",	  OMAP_MUX_MODE0 | AM33XX_PIN_INPUT_PULLUP},
	{"gpmc_ad3.gpmc_ad3",	  OMAP_MUX_MODE0 | AM33XX_PIN_INPUT_PULLUP},
	...
	/* gpmc-non-mux
	{"lcd_data0.gpmc_a0",		OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLUP},
	{"lcd_data1.gpmc_a1",		OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLUP},
	{"lcd_data2.gpmc_a2",		OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLUP},
	{"lcd_data3.gpmc_a3",		OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLUP},
	{"lcd_data4.gpmc_a4",		OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLUP},
	{"lcd_data5.gpmc_a5",		OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLUP},
	{"lcd_data6.gpmc_a6",		OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLUP},
	{"lcd_data7.gpmc_a7",		OMAP_MUX_MODE1 | AM33XX_PIN_INPUT_PULLUP},
	*/
	{NULL, 0},
};
...
static struct i2c_board_info am335x_i2c2_boardinfo[] = {
	{
		...
		I2C_BOARD_INFO("24c256", 0x54),	//	DISPLAY_CAPE_I2C_ADDR = 0x54
...
static void __init am335x_evm_init(void)
{
	...
	lcd_cape_tsc_init(DEV_ON_DGHTR_BRD, PROFILE_NONE);
	*/
	setup_pin_mux(fpga_gpmc_pin_mux);
